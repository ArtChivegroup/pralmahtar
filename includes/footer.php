...
<div class="footer-area pt-3 bg-white mb-5">
        ...
        <div class="row">
            ...
            <div class="col">
                ...
                <ul class="float-left list-unstyled ">
                    ...
                    <li class="mb-2">Selamat datang di Press Indo Entertainment! Kami adalah sumber berita dan hiburan terkemuka yang berdedikasi untuk menyajikan informasi terbaru dari dunia hiburan serta berita terkini yang relevan dan informatif. </li>
    ...
    align-items: center;">
            <p style="text-align: center; "> CopyRight by <a href="https://www.youtube.com/@artchiveip">Artchive Ip</a> Design and Developer <a href="https://artchive.eu.org">dmz</a> All Resalve
